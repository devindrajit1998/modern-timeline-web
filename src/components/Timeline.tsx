    ...
    <div className="relative">
      ...
      {items.map((item, index) => (
        <div key={index} className="relative mb-12 ml-16">
          {/* Timeline Dot */}
          <div className="absolute -left-9 top-2 w-4 h-4 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full border-4 border-gray-900"></div>
          ...
          <div className="bg-gray-800/50 rounded-lg p-6 hover:bg-gray-800/70 transition-all duration-300 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
              ...
              <span className="text-green-400 font-semibold">{item.period}</span>
            </div>
